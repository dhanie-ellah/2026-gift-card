  ...
  return (
    ...
    >
      ...
      <main className=" flex flex-col gap-2 items-center w-full m-auto">
        <div className=" h-[200px] w-[35%] lg:w-[60%] sm:w-[90%] rounded-lg bg-cover bg-center shadow-md relative flex items-center justify-center" style={{ backgroundImage: `url(${BG})` }}>
          <div className=" absolute w-full h-full top-0 left-0 flex items-center justify-center bg-black bg-opacity-75 rounded-lg text-white">
            <div>
